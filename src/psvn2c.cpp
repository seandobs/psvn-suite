...
//ruleTree->print();
  ...
  if (true) {
      cout << "  (void (*)(void*, int, int, int))abstraction_map_domain_value,\n"
           << "  (int (*)())get_numdomains,\n"
	   << "  (int (*)())get_numvars,\n"
           << "  (int (*)(int))get_domain_size,\n"
           << "  (const int8_t* (*)( const void * ))get_abstraction_value_map\n";
  } else {
      cout << "  NULL,\n"
           << "  NULL,\n"
           << "  NULL,\n"
